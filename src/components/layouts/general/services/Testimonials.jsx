...
class Testimonials extends Component {
    ...
    render() {
        return (
            <section class="testimonial-section section-py">
            <div class="container">
                <div class="row mb-n7">
                    <div class="col-xl-5 col-lg-6 mb-7">
                        <div class="title-section">
                            ...
                            <h5 class="happy-customer">
                                More over <span class="fw-bold">2500</span> happy
                                customer
                            </h5>
                        </div>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="testimonial-slide-item swiper-slide">
                                        ...
                                        <div class="avater d-flex">
                                            <div class="avater-profile">
                                                <img src={process.env.PUBLIC_URL + '/images/testimonial/avater.png'} alt="" />
                                            </div>
                                    ...
                                    <div class="testimonial-slide-item swiper-slide">
                                        ...
                                        <div class="avater d-flex">
                                            <div class="avater-profile">
                                                <img src={process.env.PUBLIC_URL + '/images/testimonial/2.png'} alt="" />
                                            </div>
                                            <div class="avater-info">
                                                <p>John Loyed</p>
                                                <span>CEO, Omex</span>
                    ...
                    <div class="col-xl-7 col-lg-6 mb-7">
                        <div class="testimonial-photo scene mt-10 mt-lg-0">
                            <div data-depth="0.2">
                                <img src={process.env.PUBLIC_URL + '/images/testimonial/1.png'} alt="" />
                            </div>
                        </div>
                    </div>
                </div>
